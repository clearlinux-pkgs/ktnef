...
Version  : 23.04.2
Release  : 55
URL      : https://download.kde.org/stable/release-service/23.04.2/src/ktnef-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/ktnef-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/ktnef-23.04.2.tar.xz.sig
...
%prep
%setup -q -n ktnef-23.04.2
cd %{_builddir}/ktnef-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686546339
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5Tnef.so.5.23.2
/usr/lib64/libKPim5Tnef.so.5
/usr/lib64/libKPim5Tnef.so.5.23.2
