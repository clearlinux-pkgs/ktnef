...
Version  : 22.04.1
Release  : 40
URL      : https://download.kde.org/stable/release-service/22.04.1/src/ktnef-22.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/ktnef-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/ktnef-22.04.1.tar.xz.sig
...
%prep
%setup -q -n ktnef-22.04.1
cd %{_builddir}/ktnef-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652665678
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ktnef-22.04.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/ktnef/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/ktnef-22.04.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/ktnef/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/ktnef-22.04.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/ktnef/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/ktnef-22.04.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ktnef/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/ktnef-22.04.1/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/ktnef/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
%find_lang libktnef5
...
/usr/lib64/libKF5Tnef.so.5.20.1
