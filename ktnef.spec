...
Version  : 23.08.5
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.5/src/ktnef-23.08.5.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/ktnef-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/ktnef-23.08.5.tar.xz.sig
...
%prep
%setup -q -n ktnef-23.08.5
cd %{_builddir}/ktnef-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708442102
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5Tnef.so.5.24.5
/usr/lib64/libKPim5Tnef.so.5
/usr/lib64/libKPim5Tnef.so.5.24.5
