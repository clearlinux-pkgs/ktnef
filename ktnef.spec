...
Version  : 22.12.0
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.0/src/ktnef-22.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/ktnef-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/ktnef-22.12.0.tar.xz.sig
...
%prep
%setup -q -n ktnef-22.12.0
cd %{_builddir}/ktnef-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670543885
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Tnef.so.5.22.0
