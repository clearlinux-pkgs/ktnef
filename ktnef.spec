...
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/ktnef-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/ktnef-19.12.3.tar.xz.sig
...
%prep
%setup -q -n ktnef-19.12.3
cd %{_builddir}/ktnef-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583513940
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ktnef-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/ktnef/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang libktnef5
...
/usr/lib64/libKF5Tnef.so.5.13.3
