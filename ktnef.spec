...
Version  : 24.12.1
Release  : 78
URL      : https://download.kde.org/stable/release-service/24.12.1/src/ktnef-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/ktnef-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/ktnef-24.12.1.tar.xz.sig
...
%setup -q -n ktnef-24.12.1
cd %{_builddir}/ktnef-24.12.1
pushd ..
cp -a ktnef-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736731043
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.3.1
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.3.1
