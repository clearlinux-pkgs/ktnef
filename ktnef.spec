...
Version  : 18.12.3
Release  : 5
URL      : https://download.kde.org/stable/applications/18.12.3/src/ktnef-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/ktnef-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/ktnef-18.12.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1555358027
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Tnef.so.5.10.3
