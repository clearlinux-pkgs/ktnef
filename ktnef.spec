...
Source0  : https://download.kde.org/stable/release-service/20.04.0/src/ktnef-20.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.0/src/ktnef-20.04.0.tar.xz.sig
...
%prep
%setup -q -n ktnef-20.04.0
cd %{_builddir}/ktnef-20.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587701272
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ktnef-20.04.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/ktnef/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang libktnef5
...
/usr/lib64/libKF5Tnef.so.5.14.0
