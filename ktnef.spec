...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/ktnef-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/ktnef-24.05.0.tar.xz.sig
...
%setup -q -n ktnef-24.05.0
cd %{_builddir}/ktnef-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716582808
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.1.0
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.1.0
