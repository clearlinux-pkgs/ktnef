...
Version  : 20.12.0
Release  : 26
URL      : https://download.kde.org/stable/release-service/20.12.0/src/ktnef-20.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/ktnef-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/ktnef-20.12.0.tar.xz.sig
...
%prep
%setup -q -n ktnef-20.12.0
cd %{_builddir}/ktnef-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607913293
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ktnef-20.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ktnef/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
%find_lang libktnef5
...
/usr/lib64/libKF5Tnef.so.5.16.0
