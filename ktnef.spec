...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/ktnef-22.08.0.tar.xz
...
%prep
%setup -q -n ktnef-22.08.0
cd %{_builddir}/ktnef-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661564898
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Tnef.so.5.21.0
