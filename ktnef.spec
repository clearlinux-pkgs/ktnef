...
Version  : 24.12.3
Release  : 80
URL      : https://download.kde.org/stable/release-service/24.12.3/src/ktnef-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/ktnef-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/ktnef-24.12.3.tar.xz.sig
...
%setup -q -n ktnef-24.12.3
cd %{_builddir}/ktnef-24.12.3
pushd ..
cp -a ktnef-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742512044
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.3.3
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.3.3
