...
Version  : 19.04.3
Release  : 10
URL      : https://download.kde.org/stable/applications/19.04.3/src/ktnef-19.04.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.3/src/ktnef-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/ktnef-19.04.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562956565
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Tnef.so.5.11.3
