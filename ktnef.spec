...
Version  : 25.04.2
Release  : 83
URL      : https://download.kde.org/stable/release-service/25.04.2/src/ktnef-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/ktnef-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/ktnef-25.04.2.tar.xz.sig
...
%setup -q -n ktnef-25.04.2
cd %{_builddir}/ktnef-25.04.2
pushd ..
cp -a ktnef-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749568475
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.4.2
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.4.2
