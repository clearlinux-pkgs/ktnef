...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/ktnef-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/ktnef-25.04.1.tar.xz.sig
...
%setup -q -n ktnef-25.04.1
cd %{_builddir}/ktnef-25.04.1
pushd ..
cp -a ktnef-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747184451
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.4.1
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.4.1
