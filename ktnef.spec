...
Version  : 22.08.2
Release  : 45
URL      : https://download.kde.org/stable/release-service/22.08.2/src/ktnef-22.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/ktnef-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/ktnef-22.08.2.tar.xz.sig
...
%prep
%setup -q -n ktnef-22.08.2
cd %{_builddir}/ktnef-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665776895
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Tnef.so.5.21.2
