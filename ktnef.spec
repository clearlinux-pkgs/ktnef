...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/ktnef-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/ktnef-24.02.1.tar.xz.sig
...
%prep
%setup -q -n ktnef-24.02.1
cd %{_builddir}/ktnef-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711123016
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.0.1
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.0.1
