...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/ktnef-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/ktnef-25.04.0.tar.xz.sig
...
%setup -q -n ktnef-25.04.0
cd %{_builddir}/ktnef-25.04.0
pushd ..
cp -a ktnef-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744995132
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Tnef.so.6.4.0
/usr/lib64/libKPim6Tnef.so.6
/usr/lib64/libKPim6Tnef.so.6.4.0
